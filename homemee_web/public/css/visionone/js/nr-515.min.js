! function(n, e, t) {
    ...
    2: [function(n, e) {
        ...
        function a(n) {
            for (var e, t = {}, r = "", o = 0; o < n.length; o++) r = n[o], t[r] = u(p[r]), t[r].length && (e = !0), delete p[r];
            return e ? t : null
        }
        ...
        function s(n, e) {
            "undefined" == typeof e && (e = (new Date).getTime()), m[n] = e
        }
    ...
    3: [function(n, e) {
        ...
        function i(n, e) {
            ...
            return u(n, function(n, i) {
                var a, u, s = [];
                if ("string" == typeof i) a = "&" + n + "=" + r(i), t += a.length, o += a;
                else if (i.length) {
                    for (t += 9, u = 0; u < i.length && (a = r(f(i[u])), t += a.length, !("undefined" != typeof e && t >= e)); u++) s.push(a);
                    o += "&" + n + "=%5B" + s.join(",") + "%5D"
                }
            }), o
        }
    ...
    5: [function(n, e) {
        function t(n, e) {
            if (n.info.beacon) {
                ...
                if (r) {
                    var o = "1",
                        i = [c(n)];
                    if (i.push(r), i.push(v("tt", n.info.ttGuid)), i.push(v("us", n.info.user)), i.push(v("ac", n.info.account)), i.push(v("pr", n.info.product)), i.push(v("tk", n.info.agentToken)), i.push(v("f", g(p(n.features, function(n) {
                            return n
                        })))), window.performance && "undefined" != typeof window.performance.timing) {
                        var a = {};
                        a.timing = m.addPT(window.performance.timing, {}), a.navigation = m.addPN(window.performance.navigation, {}), i.push(v("perf", g(a)))
                    }
                    i.push(v("xx", n.info.extra)), i.push(v("ua", n.info.userAttributes)), i.push(v("at", n.info.atts)), y({
                        url: n.proto + n.info.beacon + "/" + o + "/" + n.info.licenseKey + h.fromArray(i, n.maxBytes),
                        jsonp: w
                    })
                }
            }
        ...
        function o(n, e, t) {
            var r = i(n, t);
            return a(e, n, r.body, r.qs, t)
        }

        function i(n, e) {
            for (var t = l({}), r = l({}), o = k[n] || [], i = 0; i < o.length; i++) {
                var a = o[i](e);
                a.body && p(a.body, t), a.qs && p(a.qs, r)
            }
            return {
                body: t(),
                qs: r()
        ...
        function a(n, e, t, r, o) {
            ...
            if (!t) return !1;
            var i, a = "https://" + n.info.errorBeacon + "/" + e + "/1/" + n.info.licenseKey;
            return a += c(n), r && (a += h.obj(r, n.maxBytes)), o ? i = g(t) : a += h.obj(t, n.maxBytes), t.err && t.err.length && !b && (a += v("pve", "1"), b = !0), ("ins" === e || "stn" === e) && (a += v("ua", n.info.userAttributes), a += v("at", n.info.atts)), y({
                url: a,
                body: i
            })
        }
        ...
        function s(n) {
            return n.info.transactionName ? v("to", n.info.transactionName) : v("t", n.info.tNamePlain || "Unnamed Transaction")
        }
        ...
        function c(n) {
            return ["?a=" + n.info.applicationID, v("sa", n.info.sa ? "" + n.info.sa : ""), v("pl", "" + n.offset), v("v", x), s(n), v("ct", n.customTransaction)].join("")
        }
        ...
        var d = n(2),
            ...
            y = n(4),
            x = "515.596cecf",
            w = window.self === window.parent ? "NREUM.setToken" : !1,
            b = !1,
            k = {};
        n(5), e.exports = {
            sendBeacon: d(t),
    ...
    6: [function(n, e) {
        ...
        t.ieVersion = 4 === o ? 6 : 3 === o ? 7 : 2 === o ? 8 : 1 === o ? 9 : 0, e.exports = t.ieVersion
    }, {
        loader: !1
    }],
    7: [function(n) {
        ...
        function t(n, e, t, r, o, i) {
            if (m += 1, d.info.beacon) {
                var a = d.proto + d.info.beacon + "/1/" + d.info.licenseKey;
                a += "?a=" + d.info.applicationID + "&", a += "t=" + n + "&", a += "qt=" + e + "&", a += "ap=" + t + "&", a += "be=" + r + "&", a += "dc=" + o + "&", a += "fe=" + i + "&", a += "c=" + m, f({
                    url: a
                })
            }
        }
        ...
        function r(n) {
            var e = "s";
            "pagehide" === n.type && (e = "h"), a.navCookie && (document.cookie = "NREUM=" + e + "=" + Number(new Date) + "&r=" + o(document.location.href) + "&p=" + o(document.referrer) + "; path=/")
        }
        var o = n(1),
            i = n(2),
            a = n(6),
            ...
            p = n("ee"),
            m = 0,
            h = "undefined" != typeof window.NREUM.autorun ? window.NREUM.autorun : !0;
        window.NREUM.setToken = e, window.NREUM.inlineHit = t, d.maxBytes = 6 === n(5) ? 2e3 : 3e4;
        var v = s(r);
        i("beforeunload", v), i("pagehide", v), i("unload", function() {
            c.sendAll(d, !1)
        }), l("mark", u.mark), u.mark("done"), h && c.sendBeacon(d, u)
    }, {
        1: 10,
        2: 1,
        3: 4,
    ...
    9: [function(n, e) {
        function t(n, e) {
            if (r.listeners(n).length) return !1;
            r.on(n, e);
            var t = r.q[n];
            if (t) {
                for (var o = 0; o < t.length; o++) r.emit(n, t[o]);
                delete r.q[n]
            }
            return !0
        }
    ...
    12: [function(n, e) {
        function t() {
            var n = r() || o();
            n && (a.mark("starttime", n), u.offset = n)
        }
        ...
        function o() {
            for (var n = document.cookie.split(" "), e = 0; e < n.length; e++)
                if (0 === n[e].indexOf("NREUM=")) {
                    for (var t, r, o, u, s = n[e].substring("NREUM=".length).split("&"), f = 0; f < s.length; f++) 0 === s[f].indexOf("s=") ? o = s[f].substring(2) : 0 === s[f].indexOf("h=") ? (o = s[f].substring(2), a.store("measures", "ph", {
                        value: 1
        ...
        e.exports = function() {
            ...
            function o(t) {
                ...
                for (var o, i, a = /^\s*at (?:((?:\[object object\])?(?:[^(]*\([^)]*\))*[^()]*(?: \[as \S+\])?) )?\(?((?:file|http|https|chrome-extension):.*?)?:(\d+)(?::(\d+))?\)?\s*$/i, u = /^\s*(?:(\S*)(?:\(.*?\))?@)?((?:file|http|https|chrome|safari-extension).*?):(\d+)(?::(\d+))?\s*$/i, s = /^\s*at .+ \(eval at \S+ \((?:(?:file|http|https):[^)]+)?\)(?:, [^:]*:\d+:\d+)?\)$/i, f = /^\s*at Function code \(Function code:\d+:\d+\)\s*/i, c = t.stack.split("\n"), l = [], d = [], p = !1, m = (/^(.*) is undefined$/.exec(t.message), 0), h = c.length; h > m; ++m) {
                    if (o = u.exec(c[m])) i = {
                        ...
                        if (!s.exec(c[m]) && !f.exec(c[m]) && "anonymous" !== c[m]) {
                            d.push(c[m]);
                            continue
                        }
                        i = {
                    ...
                    e(i.func) ? p = !0 : d.push(c[m]), p || l.push(i)
                }
                return l.length ? {
                    mode: "stack",
                    name: t.name || n(t),
            ...
            function i(t) {
                for (var o, i = t.stacktrace, a = / line (\d+), column (\d+) in (?:<anonymous function: ([^>]+)>|([^\)]+))\(.*\) in (.*):\s*$/i, u = i.split("\n"), s = [], f = [], c = !1, l = 0, d = u.length; d > l; l += 2)
                    if (o = a.exec(u[l])) {
                        ...
                        e(p.func) ? c = !0 : f.push(u[l]), c || s.push(p)
                    } else f.push(u[l]);
                return s.length ? {
                    mode: "stacktrace",
                    name: t.name || n(t),
            ...
            function a(o) {
                ...
                var a, u, s, f = /^\s*Line (\d+) of linked script ((?:file|http|https)\S+)(?:: in function (\S+))?\s*$/i,
                    ...
                    h = [],
                    v = !1;
                for (u in m) t(m, u) && !m[u].src && h.push(m[u]);
                for (u = 2, s = i.length; s > u; u += 2) {
                    ...
                    g && (e(g.func) ? v = !0 : p.push(i[u]), v || d.push(g))
                }
                return d.length ? {
                    mode: "multiline",
                    name: o.name || n(o),
    ...
    17: [function(n, e) {
        ...
        function r(n, e, r) {
            ...
            for (var p = "", m = 0; m < d.frames.length; m++) {
                var h = d.frames[m],
                    v = i(h.func);
                p && (p += "\n"), v && (p += v + "@"), "string" == typeof h.url && (h.url = h.url.split("?")[0], h.url === f.origin && (h.url = "<inline>"), p += h.url), h.line && (p += ":" + h.line)
            }
            var g = {
                stackHash: s(p),
        ...
        var o = n(1),
            ...
            d = n(2),
            p = n(3);
        n(4), f.features.err && (p.on("jserrors", function() {
            return {
                body: o.take(["err", "ierr"])
            }
        }), p.pingErrors(f), setInterval(function() {
            var n = p.sendX("jserrors", f, !1);
            n || p.pingErrors(f)
    ...
    19: [function(n, e) {
        function t(n) {
            var e, t, r;
            for (e in n) t = n[e], "number" == typeof t && t > 0 && (r = n[e] - w.offset, c({
                n: e,
                s: r,
                e: r,
                o: "document",
        ...
        function a(n, e) {
            ...
            } else n && "string" == typeof n.tagName && (t = n.tagName.toLowerCase(), n.id && (t += "#" + n.id), n.className && (t += "." + E(n.classList).join(".")));
        ...
        function d() {
            ...
            var n = k(b(N, function(n, e) {
                return n in A ? k(b(k(e.sort(p), m(n), {}), h), v, []) : e
            }), v, []);
            return 0 === n.length ? {} : (N = {}, {
                qs: {
                    st: "" + w.offset,
        ...
        if (e.exports = {
            ...
            var C = setTimeout(function() {
                y("bst", g), y("bstTimer", g), y("bstResource", g), y("bstHist", g), y("bstAgg", g), y("bstApi", g)
            }, 1e4);
            _.on("rates", function(n) {
                if (n && n.stn) {
                    clearTimeout(C), t(window.performance.timing), x.on("resources", l(d));
                    ...
                    e.addEventListener("load", function() {
                        ...
                        var n = 0;
                        return Date.now() - w.offset > 9e5 ? void(N = {}) : (b(N, function(e, t) {
                            t && t.length && (n += t.length)
                        }), n > 30 && x.sendX("resources", w, !0), void(n > 1e3 && (N = {})))
                    }, 1e4)
                }
            });
            var L = 0
    ...
    20: [function(n, e) {
        function t(n, e, t) {
            e.time = t - u.offset, n.cat ? r.store("xhr", a([n.status, n.cat]), n, e) : r.store("xhr", a([n.status, n.host, n.pathname]), n, e)
        }
        var r = n(1),
            o = n(2),
            i = n(3),
            a = n(4),
            u = n("loader");
        u.features.xhr && (i.on("jserrors", function() {
            return {
                body: r.take(["xhr"])
            }
        }), o("xhr", t), e.exports = t)
    ...
    21: [function(n, e) {
        e.exports = function(n) {
            ...
            var o = e.href.split("://");
            return !r.port && o[1] && (r.port = o[1].split("/")[0].split("@").pop().split(":")[1]), r.port && "0" !== r.port || (r.port = "https" === o[0] ? "443" : "80"), r.hostname = e.hostname || t.hostname, r.pathname = e.pathname, r.protocol = o[0], "/" !== r.pathname.charAt(0) && (r.pathname = "/" + r.pathname), r.sameOrigin = !e.hostname || e.hostname === document.domain && e.port === t.port && e.protocol === t.protocol, r
        }
    }, {}],
    22: [function(n, e) {
        function t(n, e) {
