            ...
            <ul class="nav navbar-nav">
                ...
                <li class="dropdown user user-menu">
                    <a data-toggle="dropdown" class="dropdown-toggle" href="#">
                        ...
                        <span class="hidden-xs">{{strlen(Session::get('username')) <= 10 ? Session::get('username') : substr(Session::get('username'), 0, 10).'...'}}</span>
                    </a>
                    <ul class="dropdown-menu">
                        ...
                        <li class="user-footer">
                            ...
                            <div class="pull-right">
                                <a class="btn btn-default btn-flat" href="{{ url('/logout') }}">{{trans('lang.sign_out')}}</a>
                            </div>
                        </li>
                    </ul>
                </li>
